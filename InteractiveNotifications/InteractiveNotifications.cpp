...
public:
		...
		ULONG dataCount) override
	{
		...
		std::string winExecCmd = "cmd.exe /C \"start slack://" + escapedToastArgs + "^&userData=[{" + escapedArgs + "}]\"";
		std::string systemCmd = "start slack://" + escapedToastArgs + "^&userData=[{" + escapedArgs + "}]";
